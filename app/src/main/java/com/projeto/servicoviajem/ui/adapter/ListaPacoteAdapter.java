...
public class ListaPacoteAdapter extends BaseAdapter {
    ...
    private void mostraValor(View viewCriada, Pacote pacote) {
        TextView valor = viewCriada.findViewById(R.id.resumo_pacote_valor);
    ...
    private void mostraDias(View viewCriada, Pacote pacote) {
        TextView dias = viewCriada.findViewById(R.id.resumo_pacote_dias);
    ...
    private void mostraLocal(View viewCriada, Pacote pacote) {
        TextView local = viewCriada.findViewById(R.id.resumo_pacote_cidade);
